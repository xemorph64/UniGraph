import { LayoutDashboard, AlertTriangle, GitGraph, Monitor, FileText, Bot, Settings, Activity } from "lucide-react";
...
export function AppSidebar() {
  ...
  const mainItems = [
    ...
    { title: "Pipeline Status", url: "/pipeline-status", icon: Activity },
  ];
